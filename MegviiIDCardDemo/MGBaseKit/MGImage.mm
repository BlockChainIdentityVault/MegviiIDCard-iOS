...
UIImage* MGFixOrientationFromSampleBuffer(CMSampleBufferRef sampleBuffer, UIImageOrientation orientation){
    UIImage *image = MGImageFromSampleBuffer(sampleBuffer, orientation);
    return MGFixOrientationWithImage(image);
}
